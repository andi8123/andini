            ...
            <div class="card bg-danger mb-xl-8">
              <div class="card-body">
                ...
                <div class="form-check form-switch mb-3">
                  <input class="form-check-input switch-checkbox" data-parent-id="{{$menu->parent_id}}" type="checkbox" role="switch"
                    id="switch-{{ $menu->id }}" data-id="{{ $menu->id }}" name="{{ $menu->module }}"
