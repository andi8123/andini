@can($globalModule['create'])
    <x-mollecules.modal id="add-file_modal" action="{{ route('persyaratan.store') }}" tableId="filemanagement-table">
        <x-slot:title>Tambahkan File</x-slot:title>
        <div class="mb-3">
            <x-atoms.form-label required>Nama Pengantin</x-atoms.form-label>
            <x-atoms.input id="nama_pengantin" name="nama_pengantin" type="text" class="form-control"
